...
TotoGL::ShaderMaterialFactory::ObjectInstanceId getMaterial() {
    static const auto mat_id = TotoGL::ShaderMaterialFactory::create(TotoGL::ShaderMaterial(std::ifstream("assets/shader/shader.vert"), std::ifstream("assets/shader/shader.frag")));
    return mat_id;
}

TotoGL::RenderObject& makeObject() {
    static const auto tex_id = TotoGL::TextureFactory::create(TotoGL::Texture(std::ifstream("assets/textures/XYZ.png")));
    static const auto mesh_id = TotoGL::MeshFactory::create(TotoGL::Mesh::cube());
    static const auto mat_id = getMaterial();
